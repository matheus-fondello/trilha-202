...
- `oficina-pronta`: a oficina nasce aqui. Uma pasta nova, fora da sala, aberta numa segunda janela do Claude Code, com o modelo em Sonnet. Este é o passo de maior risco de desistência do módulo inteiro, e é de propósito que ele acontece agora, depois de duas aulas de conversa, com você conduzindo ao vivo. Vá devagar e um passo por mensagem. Se ele estiver no aplicativo, é o seletor de pasta: abrir uma janela nova, criar a pasta ali mesmo no diálogo, escolher. Se ele estiver no terminal, dite as duas linhas para ele copiar e diga na cara que não é para entender agora — terminal é matéria de outra aula, e hoje o trabalho dele é falar português com o agente. Confira você se a pasta ficou de pé em vez de perguntar. Registre com `oficina <caminho>`. Se o estado já tiver oficina — ele começou a trilha por outro ponto, ou refez —, só confira e siga.
