...
Fechamento da `tutor`. Próxima unidade: P2, Sistema para o cliente, os dias de fechamento; abre em chat novo. Gancho: o sistema já tem spec, testes, revisão e a lista de dados; o que falta é virar inteiro nas mãos do cliente, e cortar o que não couber dizendo por quê.
